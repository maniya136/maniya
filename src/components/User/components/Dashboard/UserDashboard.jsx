...
const MENU_ITEMS = [
  ...
  { label: "Upcoming Events", icon: FaCalendarAlt },
  { label: "Past Events", icon: FaHistory },
  { label: "Categories", icon: FaTags },
  { label: "Create Event", icon: FaPlusCircle },
  { label: "Your Events", icon: FaCalendarCheck },
  { label: "Explore Vendors", icon: FaStore },
  { label: "Guest Management", icon: FaUsers },
  { label: "Settings", icon: FaCog },
  { label: "Queries & Reports", icon: FaChartBar },
];
        ...
        return (
          <>
            ...
            <p className="ud-card-subtitle">
              Quick overview of your events, vendors and categories. Use the
              left menu to open each section.
            </p>
            <div className="ud-overview-grid">
              ...
              <section className="ud-overview-card">
                ...
                <p className="ud-overview-sub">
                  Catering, decor, photography and more.
                </p>
              </section>
              <section className="ud-overview-card">
                ...
                <p className="ud-overview-sub">
                  New RSVPs and check-in changes.
                </p>
              </section>
            </div>
          </>
      ...
      case "Upcoming Events":
        return (
          <>
            ...
            <p className="ud-card-subtitle">
              All your upcoming and live events.
            </p>
      ...
      case "Categories":
        return (
          <>
            <h2>Categories</h2>
            <p className="ud-card-subtitle">
              Event categories and experiences you can explore.
            </p>
            <div className="ud-section-wrapper">
              <CategoriesSection />
            </div>
      ...
      case "Create Event":
        return (
          <>
            <h2>Create Event</h2>
            <p className="ud-card-subtitle">
              Start creating a new event with date, venue and services.
            </p>
            <div className="ud-section-wrapper">
              <CreateEventSection />
            </div>
      ...
      case "Your Events":
        return (
          <>
            <h2>Your Events</h2>
            <p className="ud-card-subtitle">
              See and manage all events you have created.
            </p>
            <div className="ud-section-wrapper">
              <YourEventsSection />
            </div>
      ...
      case "Explore Vendors":
        return (
          <>
            ...
            <p className="ud-card-subtitle">
              Browse catering, decor, photography and more.
            </p>
            <div className="ud-section-wrapper">
      ...
      case "Guest Management":
        return (
          <>
            ...
            <p className="ud-card-subtitle">
              Manage guest lists, invites, RSVPs and check-ins.
            </p>
            <div className="ud-section-wrapper">
      ...
      case "Settings":
        return (
          <>
            <h2>Settings</h2>
            <p className="ud-card-subtitle">
              Update profile details, preferences and notifications.
            </p>
            <div className="ud-section-wrapper">
              <SettingsSection />
            </div>
      ...
      case "Queries & Reports":
        return (
          <>
            ...
            <p className="ud-card-subtitle">
              View reports and raise queries about your events.
            </p>
            <div className="ud-section-wrapper">
    ...
    <div className={`ud-shell ${sidebarOpen ? "" : "collapsed"}`}>
      <aside className="ud-sidebar">
        <div className="ud-sidebar-header">
          <div className="ud-logo-section">
            <div className="ud-logo">Evenza</div>
            {sidebarOpen && <span className="ud-logo-subtitle">Dashboard</span>}
          </div>
          <button
      ...
      <main className="ud-main">
        <div className="ud-card">{renderContent()}</div>
      </main>
    </div>
  );
};
